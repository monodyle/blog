...
export const lightTheme: ThemeRegistration = {
  ...
  colors: {
    ...
    'activityBar.background': '#ffffff80',
    ...
    'editorGroupHeader.tabsBackground': '#ffffff80',
    ...
    'editorWidget.background': '#ffffff80',
    ...
    'peekViewResult.background': '#ffffff80',
    ...
    'quickInput.background': '#ffffff80',
    ...
    'textBlockQuote.background': '#ffffff80',
    ...
    'titleBar.activeBackground': '#ffffff80',
    'titleBar.activeForeground': '#4e4f47',
    'titleBar.border': '#f7f7f7',
    'titleBar.inactiveBackground': '#ffffff80',
